  ...
  if (isSuccess) {
    return (
      <motion.div
        ...
        className="flex flex-col items-center gap-3 py-8 text-center text-white"
      >
        <CheckCircle2 size={44} className="text-primary-200" />
        ...
        <button
          ...
          className="mt-1 rounded-[3px] border border-white/40 px-4 py-2 text-sm font-semibold hover:bg-white/10"
        >
          Enviar novo contato
        </button>
      </motion.div>
